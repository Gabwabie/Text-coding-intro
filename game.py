...
background_image = pygame.transform.scale(pygame.image.load("pygame/field.jpg"), (SCREEN_WIDTH, SCREEN_HEIGHT))
...
class Sprite(pygame.sprite.Sprite):
    def __init__(self, color, height, width):
        ...
        self.image.fill(pygame.Color('dodgerblue')) #Background colour of sprite
...
while running:
    ...
    if won:
        ...
        screen.blit(win_text, ((SCREEN_HEIGHT - win_text.get_width()) // 2, (SCREEN_HEIGHT - win_text.get_height()) // 2))
